async function f() {
    ...
    const {getSession} = require('./dist/util/Login')
    ...
    const test = async (s) => {
        ...
        const ldesinldpIdentifier = `${url}private/tes/`; // Base URL of the LDES in LDP 
        const communication = new SolidCommunication(s);
